...
const experiences: Experience[] = [
  {
    ...
    description:
      "I am currently working as an SDE Intern, leveraging Express.js and TypeScript to develop and enhance backend systems. My primary contribution is to WebtoNative, a software product that transforms websites into mobile applications. My responsibilities include designing scalable APIs, optimizing system performance, and ensuring a seamless integration process to deliver a reliable and user-friendly experience.",
  },
  {
    ...
    description:
      "I have gained hands-on experience with the MERN stack (MongoDB, Express.js, React, Node.js) through building multiple projects. This experience has allowed me to develop full-stack applications, focusing on both front-end and back-end development.",
  },
];

const Experience: React.FC = () => {
  return (
    <div id="experience" className="w-[90%] sm:w-[80%] m-auto sm:pt-28">
